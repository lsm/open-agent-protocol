pub const toolchain = "go1.27.0";

pub const printable = [_][2]u21{
    ...
    .{ 0x860, 0x86A },     .{ 0x870, 0x88F },     .{ 0x897, 0x8E1 },     .{ 0x8E3, 0x983 },
    ...
    .{ 0xC55, 0xC56 },     .{ 0xC58, 0xC5A },     .{ 0xC5C, 0xC5D },     .{ 0xC60, 0xC63 },
    .{ 0xC66, 0xC6F },     .{ 0xC77, 0xC8C },     .{ 0xC8E, 0xC90 },     .{ 0xC92, 0xCA8 },
    .{ 0xCAA, 0xCB3 },     .{ 0xCB5, 0xCB9 },     .{ 0xCBC, 0xCC4 },     .{ 0xCC6, 0xCC8 },
    .{ 0xCCA, 0xCCD },     .{ 0xCD5, 0xCD6 },     .{ 0xCDC, 0xCDE },     .{ 0xCE0, 0xCE3 },
    ...
    .{ 0x2B76, 0x2CF3 },   .{ 0x2CF9, 0x2D25 },   .{ 0x2D27, 0x2D27 },   .{ 0x2D2D, 0x2D2D },
    ...
    .{ 0x10190, 0x1019C }, .{ 0x101A0, 0x101A0 }, .{ 0x101D0, 0x101FD }, .{ 0x10280, 0x1029C },
    ...
    .{ 0x11DA0, 0x11DA9 }, .{ 0x11DB0, 0x11DDB }, .{ 0x11DE0, 0x11DE9 }, .{ 0x11EE0, 0x11EF8 },
    .{ 0x11F00, 0x11F10 }, .{ 0x11F12, 0x11F3A }, .{ 0x11F3E, 0x11F5A }, .{ 0x11FB0, 0x11FB0 },
    ...
    .{ 0x16E40, 0x16E9A }, .{ 0x16EA0, 0x16EB8 }, .{ 0x16EBB, 0x16ED3 }, .{ 0x16F00, 0x16F4A },
    .{ 0x16F4F, 0x16F87 }, .{ 0x16F8F, 0x16F9F }, .{ 0x16FE0, 0x16FE4 }, .{ 0x16FF0, 0x16FF6 },
    ...
    .{ 0x1BC9C, 0x1BC9F }, .{ 0x1CC00, 0x1CCFC }, .{ 0x1CD00, 0x1CEB3 }, .{ 0x1CEBA, 0x1CED0 },
