...
const zero_width_ranges = [_]Range{
    ...
    .{ .first = 0x0890, .last = 0x0891 },
    .{ .first = 0x0898, .last = 0x089F },
...
test "control characters are width 0 via charWidth" {
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x00));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x01));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x7F));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x80));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x9F));
}
...
test "combining marks are zero-width" {
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x0300));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x0301));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x036F));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x20D0));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0xFE0F));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0xFE00));
}

test "zero-width format characters" {
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x200B));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x200C));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x200D));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0xFEFF));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x2060));
}

test "CJK ideographs are wide" {
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x4E00));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x9FFF));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x4E2D));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x6587));
}

test "Hangul syllables are wide" {
    try std.testing.expectEqual(@as(usize, 2), charWidth(0xAC00));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0xD7A3));
}

test "Hangul Jamo medials/finals are zero-width" {
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x1160));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0x11FF));
}

test "fullwidth forms are wide" {
    try std.testing.expectEqual(@as(usize, 2), charWidth(0xFF01));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0xFF21));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0xFF41));
}

test "halfwidth Katakana is normal width" {
    try std.testing.expectEqual(@as(usize, 1), charWidth(0xFF61));
    try std.testing.expectEqual(@as(usize, 1), charWidth(0xFF9F));
}

test "emoji are wide" {
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x1F600));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x1F4A9));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x1F680));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x2615));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x231A));
}

test "variation selectors are zero-width" {
    try std.testing.expectEqual(@as(usize, 0), charWidth(0xE0100));
    try std.testing.expectEqual(@as(usize, 0), charWidth(0xE01EF));
}
...
test "strWidth with mixed content" {
    ...
    try std.testing.expectEqual(@as(usize, 6), strWidth("hi中文"));
}
...
test "CJK Extension B is wide" {
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x20000));
    try std.testing.expectEqual(@as(usize, 2), charWidth(0x2A6DF));
}
