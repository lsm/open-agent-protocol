...
Unchanged: `deepseek-harness-47f9438-oap-v2` and
`deepseek-harness-47f9438-oapx-v1`, endpoint version `0.0.1`. The advertised
descriptor is identical. The tool result payload changes shape inside a feature
the descriptor already advertises. A revision identifies a descriptor, and
bumping it would claim a difference that does not exist.
...
`OAP_UPDATE_DSH_CORPUS=1`. The paths inside the recordings are the recording
host's scratch directory.

- `tool-lifecycle` (sha256
  `f357d887f31c7f399f7efcf7e790e1189def1702cb5ca3de931f346d62af75e3`): two
...
- `injected-origin` (sha256
  `644eec2960ac8ecaa7a16d521c2ceb4826442aad5ba68e6e2a1bb71b9d4fd72c`): one
