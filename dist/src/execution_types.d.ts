...
export type StopReason = "end_turn" | "max_tokens" | "tool_use" | "stop_sequence" | "max_turns" | string;
...
export type ContentPart = TextContentPart | ThinkingContentPart | ImageContentPart | ToolCallContentPart | ToolResultContentPart;
...
export type AgentStreamEvent = ProviderStreamEvent | {
    type: "agent_start";
    session_id?: string;
} | {
    type: "agent_end";
...
export declare class MakaiStreamError extends Error {
    readonly kind: MakaiStreamErrorKind;
    readonly code?: string;
    readonly provider_id?: string;
    readonly diagnostics?: TimeoutDiagnostics;
    constructor(message: string, options?: {
        kind?: MakaiStreamErrorKind;
        code?: string;
        provider_id?: string;
        diagnostics?: TimeoutDiagnostics;
    });
}
export declare class MakaiAuthRequiredError extends MakaiStreamError {
