...
exports.ModelRefParseError = void 0;
exports.parseModelRef = parseModelRef;
class ModelRefParseError extends Error {
    code;
...
exports.ModelRefParseError = ModelRefParseError;
...
function hasForbiddenSegmentChar(value) {
    return value.includes("/") || value.includes("@") || value.includes("%");
}
function validateEncodedModelId(encodedModelId) {
    let index = 0;
