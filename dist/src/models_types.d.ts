...
export type ApiId = "anthropic-messages" | "openai-completions" | "openai-responses" | "azure-openai-responses" | "google-generative-ai" | "google-gemini-cli" | "ollama" | (string & {});
export type AuthStatus = "authenticated" | "login_required" | "expired" | "refreshing" | "login_in_progress" | "failed" | "unknown";
export type ModelLifecycle = "stable" | "preview" | "deprecated";
export type ModelCapability = "chat" | "streaming" | "tools" | "vision" | "reasoning" | "prompt_cache" | "audio_input" | "audio_output";
...
export declare class MakaiProtocolError extends Error {
    readonly code?: string | undefined;
    readonly diagnostics?: TimeoutDiagnostics;
    constructor(message: string, code?: string | undefined, options?: {
